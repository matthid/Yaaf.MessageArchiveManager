...
let buildConfig =
 ...
 { BuildConfiguration.Defaults with
    ProjectName = "Yaaf.MessageArchiveManager"
    CopyrightNotice = "Yaaf.MessageArchiveManager Copyright © Matthias Dittrich 2015"
    ProjectSummary = "A library for managing xmpp messages in various back-ends."
    ProjectDescription = "A library for managing xmpp messages in various back-ends."
    ProjectAuthors = ["Matthias Dittrich"]
    NugetTags =  "fsharp csharp xmpp message archiving"
    PageAuthor = "Matthias Dittrich"
    GithubUser = "matthid"
    Version = release.NugetVersion
    NugetPackages =
      [ "Yaaf.MessageArchiveManager.nuspec", (fun config p ->
          { p with
